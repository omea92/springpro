    ...
    <div class="panel-body">
    	<form action="../boardUpdate.do" method="post">
    		...
    		<table class="table table-bordered">
    			<tr>
    				<td>제목</td>
    				<td><input type="text" name="title" class="form-control" value="${vo.title}"></input></td>
    			</tr>
    			<tr>
    				<td>내용</td>
    			...
    			<tr>
    				<td>작성자</td>
    				<td><input type="text" class="form-control" value="${vo.writer}" readonly="readonly"></input></td>
    			</tr>
    			<tr>
